...
- $f \circ g$ = execute $f$,then $g$, result is the system state
...
Does the order in which we apply related operations impact the result?
...
Examples:
- Key-value stores are associative:
